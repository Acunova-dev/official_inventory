...
const customerSchema = z.object({
  ...
  email: z.string().email({ message: "Invalid email formatting." }).or(z.literal("")).optional(),
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 backdrop-blur-xs p-4 overflow-y-auto">
            ...
            >
              ...
              <form onSubmit={handleSubmit(handleFormSubmit)} className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">
                      Direct e-mail <span className="text-slate-400 font-normal lowercase">(optional)</span>
                    </label>
                    <input
                      type="email"
                      {...register("email")}
                      ...
                      placeholder="buyer@client.com (Optional)"
                    />
                ...
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-slate-500 mb-1">
                    Physical Delivery / Billing Address <span className="text-slate-400 font-normal lowercase">(optional)</span>
                  </label>
                  <textarea
                    rows={3}
                    {...register("address")}
                    ...
                    placeholder="e.g. 100 Corporate Pkwy, Suite 400, Cupertino, CA (Optional)"
                  />
